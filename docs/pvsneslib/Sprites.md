...
You can open M8TE using the graphic-tools to create your own sprites, otherwise you can also use paint or other tileset editor

## Converting with gfx4snes

You can use **gfx4snes**, shipped with **graphic-tools** to convert your bitmap(bmp) or png files into a correct format for PVSnesLib. Remember that the size must be a multiple of 8 pixels 8x8, 16x16, 32x32, and so on ... The table above gave you the correct size you can use for your sprites at a specific moment of your homebrew.  
